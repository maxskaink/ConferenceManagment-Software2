...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (evaluator.getAllEvaluators().isEmpty()) {
                ...
                EvaluatorDTO evaluator5 = new EvaluatorDTO("55555", "Marta", "marta@gmail.com", new ArrayList<>());
                ...
                evaluator.createEvaluator(evaluator5);
            }
